export const Home = () => {
    return (
        <section className="bg-white relative lg:py-20">
            <h1 className="font-bold absolute">This specific page was copied from tailwindcomponents.com</h1>
      ...
      xl:px-5 lg:flex-row">
            ...
            relative z-10">
                            <p className="w-full text-4xl font-medium text-center leading-snug font-serif">Sign up
                                for an account</p>
